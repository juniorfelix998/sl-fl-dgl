...
def get_cifar10_loaders(num_clients, batch_size, alpha=None):  # <-- alpha added
    ...
    # --- group indices by class (UNCHANGED) ---
    class_indices = {}
    ...
    if alpha is None:
        ...
        for label in sorted(class_indices.keys()):
            ...
            # Assign any remainder due to floor truncation to the last client
...
if __name__ == "__main__":
    ...
    clients, test = get_cifar10_loaders(num_clients=10, batch_size=128, alpha=0.5)
    ...
    # 3. DGL 1:5
    reset_env()
    clients, test = get_cifar10_loaders(num_clients=5, batch_size=128,alpha=0.5)
    ...
    clients, test = get_cifar10_loaders(num_clients=1, batch_size=128,alpha=0.5)
